$(document).ready(function(){
    ...
    let list = `<div class="big_img">
                    <img src="./img/items/${menu_array[cate_no]}/${ITEM.src}" alt="">
                    <div class="magnifier" style="background: url('./img/items/${menu_array[cate_no]}/${ITEM.src}')"></div>
                </div>
                <div class="item_info">
        ...
        if(!btn_chk[$(this).index()]) {
            ...
            let sel_opt = `<div class="opt_item">
                                ...
                                <div class="opt_qty">
                                    ...
                                    <img src="img/product/btn_price_delete.gif" alt="" class="btn_close_opt">
